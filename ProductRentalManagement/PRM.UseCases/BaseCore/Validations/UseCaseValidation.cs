...
namespace PRM.UseCases.BaseCore.Validations
{
    ...
    {
        Task<UseCaseResult<TRequirementValidationResult>> Validate(TRequirement rentProductsRequirement);
    }
    ...
    {
        public abstract Task<UseCaseResult<TRequirementValidationResult>> Validate(TRequirement rentProductsRequirement);
