...
namespace PRM.UseCases.BaseCore
{
    ...
    {
        Task<UseCaseResult<TResult>> Execute(TRequirement rentProductsRequirement);
    }

    public abstract class BaseUseCase<TRequirement, TResult> : IBaseUseCase<TRequirement, TResult>
    {
        public abstract Task<UseCaseResult<TResult>> Execute(TRequirement rentProductsRequirement);
    }
}